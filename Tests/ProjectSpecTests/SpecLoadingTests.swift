...
//                    ConfigFile(path: "paths_test/config", type: "IncludedConfig"),
//                    ConfigFile(path: "config", type: "NewConfig"),
//                    ConfigFile(path: "paths_test/recursive_test/config", type: "RecursiveConfig"),
//                ]
//
