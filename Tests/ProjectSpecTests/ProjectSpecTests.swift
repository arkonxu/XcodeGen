...
//                project.configFiles = [ConfigFile(path: "invalidConfigFile", type: "invalidConfig")]
...
//                project.configFiles = [ConfigFile(path: configPath.string, type: "missingConfiguration")]
...
//                project.configFiles = [ConfigFile(path: "doesntexist.xcconfig", type: "invalid")]
//                try project.validate()
//            }
//
...
//                    settings: invalidSettings,
//                    configFiles: [ConfigFile(path: "invalidConfigFile", type: "invalidConfig")],
...
//                                                                                                                                     groups: [])],
//                                                                                         groups: ["foo"]),
//                                                                      configFiles: [ConfigFile(path: "bar", type: "configFiles")],
